...
Namespace IbUkeharai
	...
	<DesignerGenerated()>
	Public Class ListUkeharaiConfirmationLetterForm
		Inherits Form

		Public Sub New()
			AddHandler MyBase.Load, AddressOf Me.ListUkeharaiConfirmationLetterForm_Load
			Me.csvDirectory = Path.Combine("csv", "54.受払確認表")
...
#Region " フォーム "
		...
		Private Sub InitializeComponent()
			...
			Me.LUCL_ClearButton = New Button()
			Me.LUCL_SelectAllButton = New Button()
			Me.LUCL_BackButton = New Button()
			Me.LUCL_ExecutButton = New Button()
			...
			Me.FormTitleLabel.Text = "受払確認書　出力"
			...
			Me.SpecifiedDateLabel.Location = New Point(239, 78)
			Me.SpecifiedDateLabel.Name = "SpecifiedDateLabel"
			Me.SpecifiedDateLabel.Size = New Size(70, 18)
			Me.SpecifiedDateLabel.TabIndex = 37
			Me.SpecifiedDateLabel.Text = "指定年月日"
			'
			'LUCL_ClearButton
			'
			Me.LUCL_ClearButton.Font = New Font("ＭＳ Ｐゴシック", 9.0!, FontStyle.Regular, GraphicsUnit.Point, CType(128, Byte))
			Me.LUCL_ClearButton.Location = New Point(124, 72)
			Me.LUCL_ClearButton.Name = "LUCL_ClearButton"
			Me.LUCL_ClearButton.Size = New Size(80, 30)
			Me.LUCL_ClearButton.TabIndex = 1
			Me.LUCL_ClearButton.Text = "クリア"
			Me.LUCL_ClearButton.UseVisualStyleBackColor = True
			'
			'LUCL_SelectAllButton
			'
			Me.LUCL_SelectAllButton.Font = New Font("ＭＳ Ｐゴシック", 9.0!, FontStyle.Regular, GraphicsUnit.Point, CType(128, Byte))
			Me.LUCL_SelectAllButton.Location = New Point(28, 72)
			Me.LUCL_SelectAllButton.Name = "LUCL_SelectAllButton"
			Me.LUCL_SelectAllButton.Size = New Size(80, 30)
			Me.LUCL_SelectAllButton.TabIndex = 0
			Me.LUCL_SelectAllButton.Text = "全選択"
			Me.LUCL_SelectAllButton.UseVisualStyleBackColor = True
			'
			'LUCL_BackButton
			'
			Me.LUCL_BackButton.Anchor = CType((AnchorStyles.Bottom Or AnchorStyles.Right), AnchorStyles)
			Me.LUCL_BackButton.Font = New Font("ＭＳ Ｐゴシック", 9.0!, FontStyle.Regular, GraphicsUnit.Point, CType(128, Byte))
			Me.LUCL_BackButton.Location = New Point(687, 520)
			Me.LUCL_BackButton.Name = "LUCL_BackButton"
			Me.LUCL_BackButton.Size = New Size(80, 30)
			Me.LUCL_BackButton.TabIndex = 5
			Me.LUCL_BackButton.Text = "戻る"
			Me.LUCL_BackButton.UseVisualStyleBackColor = True
			'
			'LUCL_ExecutButton
			'
			Me.LUCL_ExecutButton.Anchor = CType((AnchorStyles.Bottom Or AnchorStyles.Right), AnchorStyles)
			Me.LUCL_ExecutButton.Font = New Font("ＭＳ Ｐゴシック", 9.0!, FontStyle.Regular, GraphicsUnit.Point, CType(128, Byte))
			Me.LUCL_ExecutButton.Location = New Point(592, 520)
			Me.LUCL_ExecutButton.Name = "LUCL_ExecutButton"
			Me.LUCL_ExecutButton.Size = New Size(80, 30)
			Me.LUCL_ExecutButton.TabIndex = 4
			Me.LUCL_ExecutButton.Text = "実行"
			Me.LUCL_ExecutButton.UseVisualStyleBackColor = True
			'
			'CclDateTimePicker
			'
			...
			Me.CclDateTimePicker.Location = New Point(315, 73)
			...
			'
			'ListUkeharaiConfirmationLetterForm
			'
			...
			Me.Controls.Add(Me.LUCL_BackButton)
			Me.Controls.Add(Me.LUCL_ExecutButton)
			Me.Controls.Add(Me.SpecifiedDateLabel)
			Me.Controls.Add(Me.LUCL_ClearButton)
			Me.Controls.Add(Me.LUCL_SelectAllButton)
			Me.Controls.Add(Me.FormTitleLabel)
			Dim ico As Icon = Global.IbUkeharai.My.Resources.Resources.this64
			Me.Icon = ico
			Me.Name = "ListUkeharaiConfirmationLetterForm"
			Me.Text = "受払確認書画面"
...
#End Region
		...
		Private Sub ListUkeharaiConfirmationLetterForm_Load(sender As Object, e As EventArgs)
			Me.SetToriGridView()
			Me.SetToriGridViewData()
			Me.UcSelectGridView1.CmpSgv.DisplayRowsCount()
			Me.CclDateTimePicker.Value = Nothing
			Me.CclDateTimePicker.Value = DateAndTime.Now.ToString("yyyy/MM/dd")
		End Sub
		...
		Private Function makeSql(arySelectedRows As ArrayList, syoriym As DateTime) As String
			...
			stringBuilder.Append(vbTab & vbTab & "BUH.KIKAKU       " & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & "                                                                      AS 規格, ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(BUH.ZENGETSU_ZAIKO, 0)                                                                                                         AS 前月残, ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(MEI.UKESU01, 0)                                                                                                                AS '01～10日：受入数', ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(MEI.HARAISU01, 0)                                                                                                              AS '01～10日：払出数', ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(BUH.ZENGETSU_ZAIKO, 0) + ISNULL(MEI.UKESU01 - MEI.HARAISU01, 0)                                                                AS '01～10日：在庫', ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(MEI.UKESU02, 0)                                                                                                                AS '11～20日：受入数', ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(MEI.HARAISU02, 0)                                                                                                              AS '11～20日：払出数', ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(BUH.ZENGETSU_ZAIKO, 0) + ISNULL(MEI.UKESU01 - MEI.HARAISU01 + MEI.UKESU02 - MEI.HARAISU02, 0)                                  AS '11～20日：在庫', ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(MEI.UKESU03, 0)                                                                                                                AS '21～末日：受入数', ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(MEI.HARAISU03, 0)                                                                                                              AS '21～末日：払出数', ")
			stringBuilder.Append(vbTab & vbTab & "ISNULL(BUH.ZENGETSU_ZAIKO, 0) + ISNULL(MEI.UKESU01 - MEI.HARAISU01 + MEI.UKESU02 - MEI.HARAISU02 + MEI.UKESU03 - MEI.HARAISU03, 0)    AS '21～末日：在庫' ")
			...
			Dim syoriymd As New DateTime(syoriym.Year, syoriym.Month, 1)
			...
			stringBuilder.Append("           FORMAT(UKEHARA_YYYYMMDD, 'yyyy/MM')                                                AS UKEHARA_YYYYMMDD, ")
			stringBuilder.Append("           SUM(CASE WHEN DAY(UKEHARA_YYYYMMDD) >= 1 AND DAY(UKEHARA_YYYYMMDD) <= 10 AND UKEHARAI_KBN = '1' ")
			stringBuilder.Append(vbTab & vbTab & "               THEN ISNULL(KOSU, 0) ELSE 0 END)                                          AS UKESU01, ")
			stringBuilder.Append("           SUM(CASE WHEN DAY(UKEHARA_YYYYMMDD) >= 1 AND DAY(UKEHARA_YYYYMMDD) <= 10 AND UKEHARAI_KBN = '2' ")
			stringBuilder.Append(vbTab & vbTab & "               THEN ISNULL(KOSU, 0) ELSE 0 END)                                          AS HARAISU01, ")
			stringBuilder.Append("           SUM(CASE WHEN DAY(UKEHARA_YYYYMMDD) >= 11 AND DAY(UKEHARA_YYYYMMDD) <= 20 AND UKEHARAI_KBN = '1' ")
			stringBuilder.Append(vbTab & vbTab & "               THEN ISNULL(KOSU, 0) ELSE 0 END)                                          AS UKESU02, ")
			stringBuilder.Append("           SUM(CASE WHEN DAY(UKEHARA_YYYYMMDD) >= 11 AND DAY(UKEHARA_YYYYMMDD) <= 20 AND UKEHARAI_KBN = '2' ")
			stringBuilder.Append(vbTab & vbTab & "               THEN ISNULL(KOSU, 0) ELSE 0 END)                                          AS HARAISU02, ")
			stringBuilder.Append("           SUM(CASE WHEN DAY(UKEHARA_YYYYMMDD) >= 21 AND DAY(UKEHARA_YYYYMMDD) <= 31 AND UKEHARAI_KBN = '1' ")
			stringBuilder.Append(vbTab & vbTab & "               THEN ISNULL(KOSU, 0) ELSE 0 END)                                          AS UKESU03, ")
			stringBuilder.Append("           SUM(CASE WHEN DAY(UKEHARA_YYYYMMDD) >= 21 AND DAY(UKEHARA_YYYYMMDD) <= 31 AND UKEHARAI_KBN = '2' ")
			stringBuilder.Append(vbTab & vbTab & "               THEN ISNULL(KOSU, 0) ELSE 0 END)                                          AS HARAISU03 ")
			stringBuilder.Append("     FROM ")
			stringBuilder.Append("           [Ukeharai].[T_UKEHARAIMEISAI] AS SUB")
			stringBuilder.Append("     WHERE ")
			stringBuilder.Append("           TORI_CD IN ({2}) ")
			...
			stringBuilder.Append("           TORI_CD, ")
			stringBuilder.Append("           BUHIN_CD, ")
			stringBuilder.Append("           FORMAT(UKEHARA_YYYYMMDD, 'yyyy/MM') ")
			...
			Return String.Format(stringBuilder.ToString(), syoriym.ToString("yyyy/MM/01"), syoriym.ToString("yyyy/MM/dd"), text)
		End Function
		...
		<AccessedThroughProperty("LUCL_ClearButton")>
		Private WithEvents LUCL_ClearButton As Button

		<AccessedThroughProperty("LUCL_SelectAllButton")>
		Private WithEvents LUCL_SelectAllButton As Button

		<AccessedThroughProperty("LUCL_BackButton")>
		Private WithEvents LUCL_BackButton As Button

		<AccessedThroughProperty("LUCL_ExecutButton")>
		Private WithEvents LUCL_ExecutButton As Button
		...
		Private Const CSV_FILE_NAME As String = "54.受払確認表_{0}_{1}{2}.csv"

		Private csvDirectory As String

		Private Sub LUCL_SelectAllButton_Click(sender As Object, e As EventArgs) Handles LUCL_SelectAllButton.Click
			Try
		...
		Private Sub LUCL_ClearButton_Click(sender As Object, e As EventArgs) Handles LUCL_ClearButton.Click
			Try
				For Each obj As Object In CType(Me.UcSelectGridView1.CmpSgv.Rows, IEnumerable)
					Dim dataGridViewRow As DataGridViewRow = CType(obj, DataGridViewRow)
		...
		Private Sub LUCL_ExecutButton_Click(sender As Object, e As EventArgs) Handles LUCL_ExecutButton.Click
			...
			If arrayList.Count = Me.UcSelectGridView1.CmpSgv.Rows.Count Then
				text2 = Path.Combine(text3, String.Format("54.受払確認表_{0}_{1}{2}.csv", syoriym.ToString("yyyyMM"), "", "全メーカー"))
			...
			Else
				...
				Try
					For Each obj2 As Object In arrayList
						...
						Next
						Dim fileName As String = String.Format("54.受払確認表_{0}_{1}{2}.csv", syoriym.ToString("yyyyMM"), RuntimeHelpers.GetObjectValue(dataGridViewRow2.Cells("Tori_Cd").Value), RuntimeHelpers.GetObjectValue(dataGridViewRow2.Cells("Tori_Name").Value))
		...
		Private Sub LUCL_BackButton_Click(sender As Object, e As EventArgs) Handles LUCL_BackButton.Click
			Me.Close()
		End Sub
	End Class
End Namespace
